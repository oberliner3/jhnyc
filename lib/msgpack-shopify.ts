...
export function encodeCheckoutData(data: CheckoutData): Uint8Array {
  const compressed = {
    ...
    c: {
      ...
      a: {
        s: data.customer.address.address1,
        c: data.customer.address.city,
        st: data.customer.address.province,
        pc: data.customer.address.zip,
...
export function decodeCheckoutData(data: Uint8Array): CheckoutData {
  ...
  return {
    ...
    customer: {
      ...
      address: {
        address1: ((decoded.c as Record<string, unknown>).a as Record<string, unknown>).s as string,
        city: ((decoded.c as Record<string, unknown>).a as Record<string, unknown>).c as string,
        province: ((decoded.c as Record<string, unknown>).a as Record<string, unknown>).st as string | undefined,
        zip: ((decoded.c as Record<string, unknown>).a as Record<string, unknown>).pc as string,
