      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Our Rewards Program is designed to thank our loyal customers. Members earn points on eligible purchases, 
              which can be redeemed for discounts and exclusive offers.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>Points are credited to your account after your order has shipped.</li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">Program Changes and Termination</h2>
            <p className="text-muted-foreground">
              We reserve the right to modify or terminate the Rewards Program at any time, with or without notice. 
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              If you have any questions about the Rewards Program, please contact us at rewards@storecraft.com.
            </p>
          </section>
        </div>
      </div>
